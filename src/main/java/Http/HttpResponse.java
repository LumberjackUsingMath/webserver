...
public abstract class HttpResponse {
     ...
     * 4xx: main.Client Error - The request contains bad syntax or cannot be fulfilled
     * 5xx: main.Server Error - The server failed to fulfill an apparently valid request
